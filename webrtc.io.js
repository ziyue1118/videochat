...
(function(){
  ...
  rtc.checkDataChannelSupport = function() {
    try {
      console.log("do the peerConncection");
  ...
  rtc.connect = function(server, room) {
    ...
    rtc._socket.onopen = function() {
      ...
      rtc.on('get_peers', function(data) {
        ...
        rtc._me = data.you;
        console.log("***get_peers***" + rtc.connections);
        console.log("data.connections" + data.connections);
        console.log("data.you" + data.you);
  ...
  rtc.createPeerConnection = function(id) {
    ...
    console.log("In the createPeerConnection");
  ...
  rtc.createDataChannel = function(pcOrId, label) {
    console.log("it should start here");
